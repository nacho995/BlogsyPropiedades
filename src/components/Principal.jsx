    ...
    <>
      <div className="bg-gradient-to-tr from-blue-900 to-black/60 min-h-screen flex flex-col justify-center items-center">
        ...
        <div className="flex flex-col justify-center items-center">
          <Link className="mb-4 bg-black text-white px-4 py-2 rounded hover:bg-white hover:text-black transition-colors duration-300" to="/blog">
            Añade un blog
          </Link>
          <Link className="bg-black text-white px-4 py-2 rounded hover:bg-white hover:text-black transition-colors duration-300" to="/propiedades">
            Añade una propiedad
          </Link>
        </div>
      </div>
