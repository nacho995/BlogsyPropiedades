...
export default function Navbar () {
  ...
  // Actualizamos la propiedad 'current' de la navegación de acuerdo con la ruta actual
  const updatedNavigation = navigation.map(item => ({
    ...item,
    current: location.pathname === item.href, // Marcamos el enlace como activo si coincide con la ruta
  }));
